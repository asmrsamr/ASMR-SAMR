...
def build_safety(wb):
    ...
    notes = [
        ...
        ("RULE", "Coumarin at 4.5% of the concentrate ≈ 1.26% of a 28% extrait — 84% of the IFRA cat-4 ceiling "
                 "(1.5%). Never raise coumarin above 5.0% or the concentration above 28% without re-running "
