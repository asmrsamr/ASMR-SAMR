...
def build():
    ...
    run = subtitle.add_run("Eau de Parfum production, scale-up, and selling readiness")
    ...
    add_para(doc, "The SAMR workbook now includes a Scale-Up Plan tab. Its default target is the maximum 50 ml EDP output supported by current alcohol stock.")
    add_table(
        doc,
        ["Metric", "Current workbook value"],
        [
            ["Current bottleneck", "Iso E Super"],
            ["Current max output", "About 7 x 50 ml EDP bottles"],
            ["Scale-up target", "132 x 50 ml EDP bottles"],
    ...
    for step in [
        "Set the final concentration. SAMR defaults to 20% EDP; 50 ml at density 0.85 g/ml equals 42.5 g finished perfume.",
        "Calculate alcohol from the Batch Calculator. For 50 ml EDP at 20%, the workbook target is 8.5 g concentrate and 34.0 g alcohol.",
