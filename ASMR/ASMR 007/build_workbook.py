...
def build_process_reference(wb):
    ...
    sections = [
        ...
        ("EXTRAIT DE PARFUM 28% — MASTER BATCH METHOD (the standard)", [
            ...
            "25.5 g per 30 ml, 59.5 g per 70 ml, 85 g per 100 ml). Label each: ASMR · Extrait 28% · batch ID · date.",
...
def build_pricing(wb):
    ...
    title_block(ws, 9, "PRICING & SALES",
                ...
                "you set packaging and margin. Extrait de Parfum only.", sub_cols=11)
