...
def main():
    ...
    check("10 ml EDP bottles = 35", wb[YC]["F16"].value, 35)
    check("30 ml EDP bottles = 11", wb[YC]["F18"].value, 11)
    check("50 ml EDP bottles = 7", wb[YC]["F19"].value, 7)
    check("100 ml EDP bottles = 3", wb[YC]["F21"].value, 3)
    ...
    recalc(TEST)
    wb = values(TEST)
    check("50 ml juice cost ≈ 56.03 SAR", wb[PR]["B15"].value, 56.03, 0.2)
