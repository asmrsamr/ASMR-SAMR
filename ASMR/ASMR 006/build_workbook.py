...
def build_pricing(wb):
    ...
    econ = [
        (21, "Bottles to sell", 4, FMT_INT, "you can make ~5 × 50 ml — keep some, sell the rest (see Yield & Capacity)"),
...
def build_selling_strategy(wb):
    ...
    for r, size, pr_row, positioning, recommendation in [
        (12, 30, 12, "Discovery", "Use as entry bottle"),
        (13, 50, 13, "Hero SKU", "Lead with this"),
        (14, 100, 14, "Gift / collector", "Limited upsell"),
    ]:
