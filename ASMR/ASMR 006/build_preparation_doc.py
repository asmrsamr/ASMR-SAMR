...
def build():
    ...
    add_table(
        ...
        [
            ["Default format", "Extrait de Parfum at 28%"],
            ["Default 50 ml finished mass", "42.5 g"],
            ["Default 50 ml extrait concentrate", "11.9 g"],
    ...
    for step in [
        "For a 50 ml extrait at 28%, use 11.9 g concentrate and 30.6 g alcohol at density 0.85 g/ml.",
